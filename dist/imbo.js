    ...
    if (typeof XMLHttpRequest.prototype.sendAsBinary !== 'function') {
        XMLHttpRequest.prototype.sendAsBinary = function(text) {
            if (typeof Blob !== "undefined") {
                ...
                bb.append(Imbo.Browser.getArrayBuffer(text));
...
})(Imbo);// Compatability layer for browsers
...
(function(env, undef) {
    ...
    Imbo.Url = ImboUrl;
    return ImboUrl;
})(typeof Imbo !== 'undefined' ? Imbo : {});if (typeof module !== 'undefined') {
...
(function(Imbo, undef) {
    ...
    ImboClient.prototype.getImageIdentifier = function(imgPath, callback) {
        return Imbo.Compat.md5(imgPath, callback);
    };
    ...
    ImboClient.prototype.addImage = function(imgPath, callback) {
        ...
        self.getImageIdentifier(imgPath, function(err, imageIdentifier, fileStats) {
            if (err) {
                return callback(err);
            }
            ...
            // Set up PUT-request
            var put = Imbo.Compat.request('PUT', url, function(err, res) {
                if (err) {
                    return callback(err);
            ...
            fs.createReadStream(imgPath).pipe(put);
        });
    };
    ...
    function getErrorMessage(res) {
        return res ? (res.headers['x-imbo-error-message'] || res.statusCode) : 'Unknown error';
    }
