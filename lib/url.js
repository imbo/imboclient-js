...
(function() {
    ...
    ImboUrl.prototype.getQueryString = function() {
        ...
        if (this.transformations.length) {
            // We have some transformations. Generate a transformation key that will be sent
            // to the server so the server can verify if the transformations are valid or not.
            query += query.length ? '&' : '';
